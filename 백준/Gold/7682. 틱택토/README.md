...
### 풀이
 ...
 <h2>만약 X가 이기고 O도 이기면 잘못된 것임</h2>
 <h2>X가 이기는 경우는 O보다 한개를 더 놓는 상태에서 이기는 것임</h2>
 <h2>O가 이기는 경우는 X가 놓은 개수와 동일한 상태에서 이기는 것임</h2>
 <h2>매 보드판의 상태는 X가 하나를 더 놓은 상태나 둘이 놓은 개수가 같은 상태여야함</h2>
 <h2>둘이 비긴 상황은 보드에 모든 말을 놓았을 때만 완료된 상황임</h2>
